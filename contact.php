...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Thakur College of Engineering And Technology<br>Mumbai, India 400101<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 999999999</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:xyz@example.com">xyz@example.com</a>
                </p>
